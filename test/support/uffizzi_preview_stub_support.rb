...
module UffizziPreviewStubSupport
  ...
  def stub_uffizzi_preview_list(status, body, project_slug)
  ...
  def stub_uffizzi_preview_delete_success(status, project_slug, deployment_id)
  ...
  def stub_uffizzi_preview_delete_failed(status, body, project_slug, deployment_id)
    url = deployment_uri(Uffizzi.configuration.server, project_slug, deployment_id)

    stub_request(:delete, url).to_return(status: status, body: body.to_json)
  end

  def stub_uffizzi_preview_create(status, body, project_slug)
    url = deployments_uri(Uffizzi.configuration.server, project_slug)
  ...
  def stub_uffizzi_preview_deploy_containers(status, project_slug, deployment_id)
  ...
  def stub_uffizzi_preview_activity_items(status, body, project_slug, deployment_id)
